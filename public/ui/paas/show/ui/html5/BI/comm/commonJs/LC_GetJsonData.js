...
function LC_GetJsonData(id, infoMap, itemsList){
    ...
    }else if(LC_LS.get("pid")!=""){
        retStr=retStr+"&pid="+LC_LS.get("pid");
       
    }

    if(typeCode!=""&&typeCode!=null){
       retStr=retStr+"&typeCode="+typeCode;
   } else if(LC_LS.get("typeCode")!=null&&LC_LS.get("typeCode")!=""&&LC_LS.get("typeCode")!=undefined){
      retStr=retStr+"&typeCode="+LC_LS.get("typeCode");
    }
