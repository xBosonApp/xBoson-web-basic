 ...
 *                               is being closed.
 */
jsoneditor.Node.prototype.showContextMenu = function (anchor, onClose, option) {
 ...
 */
jsoneditor.ContextMenu.prototype.show = function (anchor,option) {
	this.hide();
	...
	this.dom.menu.style.left = option.x + 'px';
	this.dom.menu.style.top = option.y + 'px';
 ...
 *                               is being closed.
 */
jsoneditor.AppendNode.prototype.showContextMenu = function (anchor, onClose,option) {
	var node = this;
	var titles = jsoneditor.Node.TYPE_TITLES;
	var items = [
...
app.resize = function () {
	...
	if (app.splitter) {
		...
		// resize formatter
		domFormatter.style.width = '400px';
		domFormatter.style.height = '150px';
