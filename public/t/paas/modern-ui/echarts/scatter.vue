...
option = {
    ...
    series: [{
        ...
        labelLayout: function () {
            return {
                x: this.getWidth ? this.getWidth() - 100 : 500,
                moveOverlap: 'shiftY'
            };
        },
        labelLine: {
...
function d11() {
  return data.get('masterPainterColorChoice.json', function(json) {
  ...
  //   Vue.http.get(url_prefix + __dirname +'/data/masterPainterColorChoice.json').catch(fail).then(function (ret) {
  //       let json = ret.body;
