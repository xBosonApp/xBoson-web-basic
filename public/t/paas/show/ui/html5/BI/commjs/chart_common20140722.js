...
var fetchDataForPie = function(data) {
    var dataArray = [];
    for (var key in data) {
        if ('机构' !== key && '专病门诊人数' !== key && '专科门诊人数' !== key && '特需门诊人数' !== key && '退号人数' !== key && '体检人次' !== key && '体检人次数' !== key && '挂号人数' !== key && '住院诊断数' !== key && '诊断总数' !== key && '当值医生数量' !== key && '出院病人床日' !== key && '平均占床日' !== key && '留观入院人数' !== key && '留观出院人数' !== key && '累计规范建档率' !== key && '纸制档案累计人数' !== key && '纸制累计建档率' !== key && '计算机档案规范管理累计人数' !== key && '健康管理人数（儿童）' !== key && '健康（规范）管理人数' !== key && '上一年度末常住人口总数' !== key && '中医药健康管理人数' !== key  && '应管理人数（糖尿病）' !== key && '应管理人数（高血压）' !== key) {
