...
function Module(con, param, done) {
  ...
  thiz.fn.GetHTML = function (cb) {
    ...
    zy.net.loadHTML('bi/chart_widget2.html', $('<div>'), function (HTMLstr) {
  ...
  thiz.fn.DrillDown = function(param){
    ...
    if(module.list.length === 0){
      ...
      Init(param,  [{
        modid: module.modid,
        search: module.chart.modoldata.search,
  ...
  /* 构建查询条件 */
  thiz.fn.BuildSearch = function(search, searchparam){
