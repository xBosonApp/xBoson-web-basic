...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		start = function(elFinder, config, editors) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('../../web/cdn/jqueryui/1.12.1/jquery-ui.theme.css');
		...
		// JavaScript loader (REQUIRED) ../../web/cdn/elFinder/2.1.51/js/
		load = function() {
			require(
				[
					'elfinder'
					, 'elFinderConfig'
				// 	, 'editors.default.min'               // load text, image editors
	...
	require.config({
		...
		paths : {
			...
			'jquery-ui': 'jqueryui/1.12.1/jquery-ui.min',
			'elfinder' : 'elFinder/2.1.51/js/elfinder.min',
